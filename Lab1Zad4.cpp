...
int main()
{
	...
	p4.DodajPostac("Kai","Ogień",30,10,1000);
		    ...
		    p4.Wypisz(gatunek4,imie4,obrona4,atak4,szybkosc4);
			  ...
			  cout << "MikroNinjago" << endl << endl;
			  	...
			  	switch ( wybor )
			  	     ...
			  	     case 4 :
			  	  	 cout << "Jako pierwszą postac wybrałes: " << endl;
			  	  			  	            p4.PokarzDane();
			  	  			  	      p4.Wypisz(type,name,defens,atack,speed);
			  	    	 	break;
			  	         default:
			  	            cout <<"Błędny wybór";
			  	      }
			  	...
			  	switch ( wybor2 )
						  	     ...
						  	     case 4 :
						  	    	 cout << "Jako drugą postac wybrałes: " << endl;
						  	    			p4.PokarzDane();
						  	    			p4.Wypisz(type2,name2,defens2,atack2,speed2);
						  	    	 	break;
						  	         default:
						  	            cout <<"Błędny wybór";
						  	      }
